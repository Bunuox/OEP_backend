...
#farklı os'lerde dosya dizini belirtmek icin dikkat et, daha sonra secilen model face_cascade objesine atanmis olur.
...
path_frames = os.path.join('python', '*.png') #frameleri alacagimiz dizini burada tutacagiz. daha sonra buraya tekrar bak.
